...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(electromagnet_power_supply, new Chemistry.Point(1600, 700), 711 * 0.5, 362 * 0.5, canvas);
    sq.name = 'Electromagnet Power Supply';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(electromagnet, new Chemistry.Point(1600, 300), 614 * 0.5, 324 * 0.5, canvas);
    sq.name = 'Electromagnet';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(gauss_meter, new Chemistry.Point(350, 250), 679 * 0.5, 351 * 0.5, canvas);
    sq.name = 'Gauss Meter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(gauss_probe, new Chemistry.Point(250, 750), 406 * 0.5, 510 * 0.5, canvas);
    sq.name = 'Gauss Probe';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(wooden_stand, new Chemistry.Point(900, 350), 174 * 0.5, 265 * 0.5, canvas);
    sq.name = 'Wooden Stand';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(weighing_machine, new Chemistry.Point(900, 700), 835 * 0.5, 501 * 0.5, canvas);
...
function a1_load_questions() { }
{
    ...
    question.push({
        ...
        hint: ['Rectangular in shape', 'Has a display'],
    });
    question.push({
        srno: 2,
...
function load_higlighted_images() {
    highlighted_images = [
        [electromagnet_power_supply, electromagnet_power_supply],
    ...
    a1_labels = [
        new Chemistry.Geo_Text('Electromagnet power supply', new Chemistry.Point(1400, 560), canvas),
        new Chemistry.Geo_Text('Electromagnet', new Chemistry.Point(1500, 170), canvas),
        new Chemistry.Geo_Text('Gauss Meter', new Chemistry.Point(250, 350), canvas),
        new Chemistry.Geo_Text('Gauss Probe', new Chemistry.Point(100, 650), canvas),
        new Chemistry.Geo_Text('Wooden Stand', new Chemistry.Point(950, 300), canvas),
        new Chemistry.Geo_Text('Weighing Machine', new Chemistry.Point(800, 850), canvas),
    ];
    a1_labels[0].font = '30%';
    a1_labels[1].font = '30%';
    a1_labels[2].font = '30%';
