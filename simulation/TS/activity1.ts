...
function load_higlighted_images() {
	...
	a1_labels = [
		new Chemistry.Geo_Text(
			...
			new Chemistry.Point(1400, 560),
			canvas
		),

		new Chemistry.Geo_Text(
			'Electromagnet',
			new Chemistry.Point(1500, 170),
			canvas
		),

		new Chemistry.Geo_Text(
			'Gauss Meter',
			new Chemistry.Point(250, 350),
			canvas
		),

		new Chemistry.Geo_Text(
			'Gauss Probe',
			new Chemistry.Point(100, 650),
			canvas
		),

		new Chemistry.Geo_Text(
			'Wooden Stand',
			new Chemistry.Point(950, 300),
			canvas
		),
